...
export default function HelpAndSupportScreen() {
    ...
    const faqs: FAQ[] = [
        {
            ...
            answer: 'Vào tab "Sân", chọn sân bạn muốn đặt, chọn ngày giờ phù hợp và nhấn "Đặt sân". Xác nhận thông tin và thanh toán để hoàn tất.',
        },
        {
            id: '2',
            category: 'booking',
            question: 'Tôi có thể hủy đặt sân không?',
            answer: 'Có, bạn có thể hủy đặt sân trước 24 giờ để được hoàn tiền 100%. Hủy trong vòng 24 giờ sẽ bị trừ 50% phí đặt sân.',
        },
        {
            id: '3',
            category: 'tournament',
            question: 'Cách đăng ký tham gia giải đấu?',
            answer: 'Vào tab "Giải đấu", chọn giải bạn muốn tham gia, nhấn "Đăng ký" và điền đầy đủ thông tin. Thanh toán lệ phí để hoàn tất đăng ký.',
        },
        {
            id: '4',
            category: 'tournament',
            question: 'Điều kiện tham gia giải đấu?',
            answer: 'Mỗi giải đấu có yêu cầu riêng về độ tuổi, giới tính và trình độ. Vui lòng đọc kỹ mô tả giải đấu trước khi đăng ký.',
        },
        {
            id: '5',
            category: 'account',
        ...
        },
        {
            ...
            answer: 'Chúng tôi hỗ trợ thanh toán qua thẻ ATM, thẻ tín dụng, ví điện tử (MoMo, ZaloPay, VNPay) và chuyển khoản ngân hàng.',
        },
    ];
        ...
        return (
            ...
            >
                <View style={localStyles.faqHeader}>
                    <View style={{ flex: 1 }}>
                        <Text style={[localStyles.faqCategory, { color: colors.tint }]}>
                            {getCategoryLabel(faq.category)}
                        </Text>
                        <Text style={[localStyles.faqQuestion, { color: colors.text }]}>
                            {faq.question}
                        </Text>
                    </View>
                    <Ionicons
                ...
                {isExpanded && (
                    <Text style={[localStyles.faqAnswer, { color: colors.textSecondary }]}>
                        {faq.answer}
                    </Text>
                )}
            </TouchableOpacity>
    ...
    const renderContactMethod = (method: ContactMethod) => (
        ...
        >
            ...
            <View style={localStyles.contactInfo}>
                <Text style={[localStyles.contactLabel, { color: colors.text }]}>
                    {method.label}
                </Text>
                <Text style={[localStyles.contactValue, { color: colors.textSecondary }]}>
                    {method.value}
                </Text>
            </View>
    ...
    const renderQuickAction = (icon: string, label: string, onPress: () => void, iconColor: string) => (
        ...
        >
            ...
            <Text style={[localStyles.quickActionLabel, { color: colors.text }]}>
                {label}
            </Text>
        </TouchableOpacity>
    );
                ...
                <View style={[localStyles.section, { marginBottom: 40 }]}>
                    ...
                    <View style={[localStyles.resourceCard, { backgroundColor: colors.card }]}>
                        ...
                        <View style={{ flex: 1, marginLeft: 12 }}>
                            <Text style={[localStyles.resourceTitle, { color: colors.text }]}>
                                Trung tâm trợ giúp
                            </Text>
